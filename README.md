...
| 6    | `dvmp_fourier.c`           | Computes the Fourier transform of the fitted (t)-distribution to obtain the transverse spatial distribution.                                                        | Output of `dvmp_t_fitting.c`                                                      |
...
| 8    | `plot_FT_Jihee.C`          | Uses the modified Jihee Fourier-transform implementation to generate the normalized Fourier distributions and final comparison plots.                               | Outputs of `dvmp_fourier.c` (and associated cross-section results, if applicable) |
